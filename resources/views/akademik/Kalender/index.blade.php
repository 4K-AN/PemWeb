...
@section('title', 'Kalender Akademik - Edvizor')

@section('styles')
<style>
    body { 
        background: linear-gradient(135deg, #d6d3d1 0%, #a7f3d0 100%); 
        min-height: 100vh; 
    }
    ...
    .calendar-container { 
        ...
        border: 1.5px solid rgba(161, 161, 170, 0.4); 
    }
...
<div class="main-content">
    <div class="calendar-container">
        ...
        <div class="calendar-grid">
            ...
            <a href="{{ route('akademik.detail', ['day' => 1]) }}" class="calendar-day highlighted">1</a>
            <a href="{{ route('akademik.detail', ['day' => 2]) }}" class="calendar-day highlighted">2</a>
            ...
            <a href="{{ route('akademik.detail', ['day' => 15]) }}" class="calendar-day highlighted">15</a>
            <div class="calendar-day default">16</div>
            
            <!-- Week 4 -->
            <a href="{{ route('akademik.detail', ['day' => 17]) }}" class="calendar-day today">17</a>
            <div class="calendar-day default">18</div>
            <div class="calendar-day default">19</div>
            <a href="{{ route('akademik.detail', ['day' => 20]) }}" class="calendar-day highlighted">20</a>
            ...
            <a href="{{ route('akademik.detail', ['day' => 28]) }}" class="calendar-day highlighted">28</a>
            
            <!-- Week 6 -->
            <div class="calendar-day default">29</div>
            <a href="{{ route('akademik.detail', ['day' => 30]) }}" class="calendar-day highlighted">30</a>
...
<footer class="footer">
    <div class="footer-links">
        ...
        <a href="#" class="footer-link">Experts</a>
    ...
    <div class="footer-contact">
        <div class="contact-item">
            <span>💬</span>
            <span style="color: #64748b;">Let's chat</span>
        </div>
        <div class="contact-item">
            <span>📧</span>
            <span>info@edvizo.com</span>
        </div>
    </div>
</footer>
@endsection
